...
---
Hello! I'm Ioannis, a data scientist with a passion for machine learning, generative AI, and computer vision. I graduated from the University of Cambridge with a Master of Engineering (MEng) in Information and Computer Engineering. Currently, I am working at Data Reply UK as a data scientist and consultant, where I apply my machine learning and AWS expertise to solve complex problems and develop innovative solutions for clients.

I strive to keep up to date with both academia and industry, combining insights from each to achieve the best outcomes. You can explore some of the topics I am interested in within the [Articles]({{ site.baseurl }}/articles/).
